...
namespace ScaffoldersProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Search(string search)
        {
            ...
            {
                if ( item.Name.ToLower().Contains(search.ToLower()) || item.Category.ToLower().Contains(search.ToLower()) /*|| item.Stock.Equals(int.Parse(search)) || item.Price.Equals(decimal.Parse(search))*/)
                {
